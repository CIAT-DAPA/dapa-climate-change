...
if len(sys.argv) < 6:
	...
	print "    - ie: python 02_MergeShapefiles.py F:\yapu_climate_risk\indices E:\yapu_climate_risk\continental\latinamerica LAC cdd historical"
	sys.exit(1)
		...
		for index in indices_list: 
			...
			for enos in enosCond:
				...
				for month in range(1, 12 + 1, 1):
					...
					inshp = dirin + "\\" + str(iso) + "\\" + scen  + "\\" + index  + "\\" + index + "_" + str(iso) + "_" + str(month) + "_" + enos + ".shp" 
					inrst = dirin + "\\" + str(iso) + "\\" + scen  + "\\" + index  + "\\" + index + "_" + str(iso) + "_" + str(month) + "_" + enos + ".tif" 
					inshpmag = dirin + "\\" + str(iso) + "\\" + scen  + "\\" + index  + "\\" + index + "_" + str(iso) + "_" + str(month) + "_" + enos + "_mag.shp" 
					inrstmag = dirin + "\\" + str(iso) + "\\" + scen  + "\\" + index  + "\\" + index + "_" + str(iso) + "_" + str(month) + "_" + enos + "_mag.tif" 
					
					gp.ExtractByMask_sa(inshp, mask, dirout + "\\" + os.path.basename(raster))
...
for enos in enosCond:
    ...
    for month in range(1, 12 + 1, 1): 
        ...
        for iso in iso_list:
			...
			inshp = dirin + "\\" + str(iso) + "\\" + scen  + "\\" + index  + "\\" + index + "_" + str(iso) + "_" + str(month) + "_" + enos + ".shp" 
			inrst = dirin + "\\" + str(iso) + "\\" + scen  + "\\" + index  + "\\" + index + "_" + str(iso) + "_" + str(month) + "_" + enos + ".tif" 
			inshpmag = dirin + "\\" + str(iso) + "\\" + scen  + "\\" + index  + "\\" + index + "_" + str(iso) + "_" + str(month) + "_" + enos + ".shp" 
			inrstmag = dirin + "\\" + str(iso) + "\\" + scen  + "\\" + index  + "\\" + index + "_" + str(iso) + "_" + str(month) + "_" + enos + ".tif" 
