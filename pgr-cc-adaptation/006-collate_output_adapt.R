...
for (gcm_i in c(3:6,9,16,19)) {
  ...
  plot_overlap("RICE", "CTR_2035", xt=extent(-130,160,-45,75), fig_dir)
  plot_overlap("RICE", "CTR_2075", xt=extent(-130,160,-45,75), fig_dir)
  plot_overlap("RICE", "GLO_2035", xt=extent(-130,160,-45,75), fig_dir)
  plot_overlap("RICE", "GLO_2075", xt=extent(-130,160,-45,75), fig_dir)
  
  plot_overlap("WSPR", "BUF_2035", xt=extent(-130,160,-45,75), fig_dir)
  plot_overlap("WSPR", "BUF_2075", xt=extent(-130,160,-45,75), fig_dir)
  plot_overlap("WSPR", "CTR_2035", xt=extent(-130,160,-45,75), fig_dir)
  plot_overlap("WSPR", "CTR_2075", xt=extent(-130,160,-45,75), fig_dir)
  plot_overlap("WSPR", "GLO_2035", xt=extent(-130,160,-45,75), fig_dir)
  plot_overlap("WSPR", "GLO_2075", xt=extent(-130,160,-45,75), fig_dir)
  
  plot_overlap("WWIN", "BUF_2035", xt=extent(-130,160,-45,75), fig_dir)
  plot_overlap("WWIN", "BUF_2075", xt=extent(-130,160,-45,75), fig_dir)
  plot_overlap("WWIN", "CTR_2035", xt=extent(-130,160,-45,75), fig_dir)
  plot_overlap("WWIN", "CTR_2075", xt=extent(-130,160,-45,75), fig_dir)
  plot_overlap("WWIN", "GLO_2035", xt=extent(-130,160,-45,75), fig_dir)
  plot_overlap("WWIN", "GLO_2075", xt=extent(-130,160,-45,75), fig_dir)
  
  plot_overlap("WHEA", "BUF_2035", xt=extent(-130,160,-45,75), fig_dir)
  plot_overlap("WHEA", "BUF_2075", xt=extent(-130,160,-45,75), fig_dir)
  plot_overlap("WHEA", "CTR_2035", xt=extent(-130,160,-45,75), fig_dir)
  plot_overlap("WHEA", "CTR_2075", xt=extent(-130,160,-45,75), fig_dir)
  plot_overlap("WHEA", "GLO_2035", xt=extent(-130,160,-45,75), fig_dir)
  plot_overlap("WHEA", "GLO_2075", xt=extent(-130,160,-45,75), fig_dir)
  
  plot_overlap("MILL", "BUF_2035", xt=extent(-130,160,-45,75), fig_dir)
  plot_overlap("MILL", "BUF_2075", xt=extent(-130,160,-45,75), fig_dir)
  plot_overlap("MILL", "CTR_2035", xt=extent(-130,160,-45,75), fig_dir)
  plot_overlap("MILL", "CTR_2075", xt=extent(-130,160,-45,75), fig_dir)
  plot_overlap("MILL", "GLO_2035", xt=extent(-130,160,-45,75), fig_dir)
  plot_overlap("MILL", "GLO_2075", xt=extent(-130,160,-45,75), fig_dir)
  
  plot_overlap("SORG", "BUF_2035", xt=extent(-130,160,-45,75), fig_dir)
  plot_overlap("SORG", "BUF_2075", xt=extent(-130,160,-45,75), fig_dir)
  plot_overlap("SORG", "CTR_2035", xt=extent(-130,160,-45,75), fig_dir)
  plot_overlap("SORG", "CTR_2075", xt=extent(-130,160,-45,75), fig_dir)
  plot_overlap("SORG", "GLO_2035", xt=extent(-130,160,-45,75), fig_dir)
  plot_overlap("SORG", "GLO_2075", xt=extent(-130,160,-45,75), fig_dir)
}
