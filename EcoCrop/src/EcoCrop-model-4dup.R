...
suitCalc <- function(climPath='', sowDat='', harDat='', Gmin=240,Gmax=240,Tkmp=0,Tmin=15,Topmin=22,Topmax=32,Tmax=45,Rmin=300,Ropmin=800,Ropmax=2200,Rmax=2800, outfolder='', cropname='',ext=".asc",cropClimate=F) {
  minAdapt <- 0
  maxAdapt <- 1
