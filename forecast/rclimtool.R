...
# #---------------------------------------------------------------------
#
if(require(ggplot2)==FALSE){install.packages("ggplot2", repos="http://cran.rstudio.com/", dependencies=TRUE)}
if(require(rtf)==FALSE){ install.packages("rtf", repos="http://cran.rstudio.com/", dependencies=TRUE)}
if(require(gWidgets)==FALSE){install.packages("gWidgets", repos="http://cran.rstudio.com/", dependencies=TRUE)}
if(require(gWidgetsRGtk2)==FALSE){install.packages("gWidgetsRGtk2", repos="http://cran.rstudio.com/", dependencies=TRUE) }
if(require(RMAWGEN)==FALSE){install.packages("RMAWGEN", repos="http://cran.rstudio.com/", dependencies=TRUE) }
if(require(Kendall)==FALSE){install.packages("Kendall", repos="http://cran.rstudio.com/", dependencies=TRUE) }
if(require(tseries)==FALSE){install.packages("tseries", repos="http://cran.rstudio.com/", dependencies=TRUE)}
if(require(grid)==FALSE){install.packages("grid", repos="http://cran.rstudio.com/", dependencies=TRUE)}
if(require(car)==FALSE){ install.packages("car", repos="http://cran.rstudio.com/", dependencies=TRUE) }
if(require(reshape)==FALSE){ install.packages("reshape", repos="http://cran.rstudio.com/", dependencies=TRUE)}
if(require(maptools)==FALSE){install.packages("maptools", repos="http://cran.rstudio.com/", dependencies=TRUE)}
if(require(mapdata)==FALSE){install.packages("mapdata", repos="http://cran.rstudio.com/", dependencies=TRUE)}
if(require(RColorBrewer)==FALSE){install.packages("RColorBrewer", repos="http://cran.rstudio.com/", dependencies=TRUE)}
if(require(classInt)==FALSE){install.packages("classInt", repos="http://cran.rstudio.com/", dependencies=TRUE)}
if(require(gpclib)==FALSE){install.packages("gpclib", repos="http://cran.rstudio.com/", dependencies=TRUE)}
if(require(DescTools)==FALSE){install.packages("DescTools", repos="http://cran.rstudio.com/", dependencies=TRUE)}
...
require(DescTools) #Prueba no paramétrica Siegel Tukey para igualdad de varianzas
...
confirmDialog <- function(message,title, handler=NULL) { o
...
grafcontrol<-function(object){
  ...
  if(svalue(variable)=="tmax"){
    ...
    {
      jpeg(paste("Control de calidad/tmax/tmax_",station[i],".jpeg",sep=""), width = 10, height = 7,units = 'in',res=200)
  ...
  if(svalue(variable)=="tmin"){
    ...
    for(i in 1:(ncol(object)-3))
    {
      jpeg(paste("Control de calidad/tmin/tmin_",station[i],".jpeg",sep=""), width = 10, height = 7,units = 'in',res=200)
  ...
  if(svalue(variable)=="precip"){
    ...
    for(i in 1:(ncol(object)-3))
    {
      jpeg(paste("Control de calidad/precip/precip_",station[i],".jpeg",sep=""), width = 10, height = 7,units = 'in',res=200)
...
validar2<-function(object){
  ...
  if(svalue(variable)=="tmax"){
    ...
    for(i in 1:(ncol(object)-3))
    {
      ...
      pos4=which(abs(diff(object[,i+3]))>=svalue(criterio1))
...
#-----------------------------------------------------------------------------------
###---------------------Funciones Remuestreo determinísticos---------------------###
#-----------------------------------------------------------------------------------
...
lyt3=glayout(homogeneous =F,cont=nb,spacing=1,label="4. Llenado de datos faltantes",expand=T)
