...
#output directories
wth_dir <- paste(asc_dir,"/wth-cmip5_rcp45",sep="")
...
#list of gcms
gcm_chars <- read.table(paste(src.dir2,"/data/CMIP5gcms_rcp45.tab",sep=""),header=T,sep="\t")
...
system.time(sfSapply(as.vector(1:nrow(proc_list)),wth_rcp45_wrapper))
