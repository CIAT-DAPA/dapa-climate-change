...
# python daily_extreme_stats_cdo_main_fix.py /home/jtarapues/stats_code-master/faltante.txt

if len(argv) != 2:
	print "Usage: python daily_extreme_stats_cdo_main.py file"
	exit(1)
...
for n in file.readlines():
	index= n.split("\t")[0]
	scens= n.split("\t")[1]
	model= n.split("\t")[2].split("\n")[0].split("\r")[0]
	
	if model!="GFDL-CM3":	
		var_stat = [index.lower()]
		print index.lower(),scens,model
