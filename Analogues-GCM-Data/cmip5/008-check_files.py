...
# ----------------------------------------------------------------------------------
	...
	# ++++ STMARIA ++++++
# python 008-check_files.py U:\portals\ccafs-analogues\TilesByCountry U:\portals\ccafs-analogues\TilesByCountry rcp26 30s 2020_2049 165 fix 0 10000
# python 008-check_files.py U:\portals\ccafs-analogues\TilesByCountry U:\portals\ccafs-analogues\TilesByCountry rcp26 30s 2020_2049 165 fix 10000 20000
# python 008-check_files.py U:\portals\ccafs-analogues\TilesByCountry U:\portals\ccafs-analogues\TilesByCountry rcp26 30s 2020_2049 165 fix 20000 31387

	# ++++ PINTA ++++++
# python 008-check_files.py U:\data\portals\ccafs-analogues\TilesByCountry U:\data\portals\ccafs-analogues\TilesByCountry rcp85 30s 2020_2049 165 fix 0 5000
# python 008-check_files.py U:\data\portals\ccafs-analogues\TilesByCountry U:\data\portals\ccafs-analogues\TilesByCountry rcp85 30s 2020_2049 165 fix 5000 10000
# python 008-check_files.py U:\data\portals\ccafs-analogues\TilesByCountry U:\data\portals\ccafs-analogues\TilesByCountry rcp85 30s 2020_2049 165 fix 10000 15000
# python 008-check_files.py U:\data\portals\ccafs-analogues\TilesByCountry U:\data\portals\ccafs-analogues\TilesByCountry rcp85 30s 2020_2049 165 fix 15000 20000
...
if len(sys.argv) < 5:
	os.system('cls')
	print "\n Too few args"
	print "   - ie: python 008-check_files.py U:\portals\ccafs-analogues\TilesByCountry U:\portals\ccafs-analogues\TilesByCountry rcp26 2_5min,5min,10min 2020_2049 165 check 0 len(check)"
	sys.exit(1)
...
res = sys.argv[4]
period = sys.argv[5]
n = sys.argv[6] # para check
type = sys.argv[7] # check o fix
start = sys.argv[8] # para fix
end = sys.argv[9] # para fix


# base = "U:\data\portals\ccafs-analogues\grid_files\\" # pinta
base = "U:\portals\ccafs-analogues\grid_files\\" # other

os.system('cls')

if res == "ALL":
	resoList = ["30s", "2_5min","5min", "10min"]
else:
	resoList = res.split(",")

for resolution in resoList:
	l = open(base+"listcountries_"+resolution+".list", "r")	
	...
	if resolution == "30s":
		...
		"ala": "1 1 ", "alb": "1 1 ", "asm": "1 1 ", "and": "1 1 ", "aia": "1 1 ", "atg": "1 1 ", "arm": "1 1 ", "abw": "1 1 ", "bhs": "1 1 ", "bhr": "1 1 ", "brb": "1 1 ", "bel": "1 1 ", "blz": "1 1 ", "bmu": "1 1 ", "btn": "1 1 ", "bih": "1 1 ", "bvt": "1 1 ", "iot": "1 1 ", "vgb": "1 1 ", "brn": "1 1 ", "bdi": "1 1 ", "cpv": "1 1 ", "cym": "1 1 ", "cxr": "1 1 ", "cck": "1 1 ", "com": "1 1 ", "cok": "1 1 ", "cri": "1 1 ", "cyp": "1 1 ", "dji": "1 1 ", "dma": "1 1 ", "slv": "1 1 ", "imn": "1 1 ", "isr": "1 1 ", "gnq": "1 1 ", "flk": "1 1 ", "fji": "1 1 ", "fro": "1 1 ", "pyf": "1 1 ", "atf": "1 1 ", "gmb": "1 1 ", "gib": "1 1 ", "grd": "1 1 ", "glp": "1 1 ", "gum": "1 1 ", "ggy": "1 1 ", "gnb": "1 1 ", "hti": "1 1 ", "hmd": "1 1 ", "hkg": "1 1 ", "jam": "1 1 ", "jey": "1 1 ", "kir": "1 1 ", "kwt": "1 1 ", "lbn": "1 1 ", "lso": "1 1 ", "lie": "1 1 ", "lux": "1 1 ", "mac": "1 1 ", "mkd": "1 1 ", "mdv": "1 1 ", "mlt": "1 1 ", "mhl": "1 1 ", "mtq": "1 1 ", "mus": "1 1 ", "myt": "1 1 ", "fsm": "1 1 ", "mda": "1 1 ", "mco": "1 1 ", "mne": "1 1 ", "msr": "1 1 ", "ncl": "1 1 ", "niu": "1 1 ", "nfk": "1 1 ", "mnp": "1 1 ", "plw": "1 1 ", "pse": "1 1 ", "pcn": "1 1 ", "pri": "1 1 ", "qat": "1 1 ", "nru": "1 1 ", "nld": "1 1 ", "ant": "1 1 ", "dom": "1 1 ", "reu": "1 1 ", "rwa": "1 1 ", "shn": "1 1 ", "kna": "1 1 ", "spm": "1 1 ", "sgs": "1 1 ", "sp-": "1 1 ", "lka": "1 1 ", "che": "1 1 ", "swz": "1 1 ", "twn": "1 1 ", "tls": "1 1 ", "tgo": "1 1 ", "tkl": "1 1 ", "ton": "1 1 ", "tto": "1 1 ", "tca": "1 1 ", "tuv": "1 1 ", "umi": "1 1 ", "vut": "1 1 ", "vat": "1 1 ", "vir": "1 1 ", "wlf": "1 1 ", "ko-": "1 1 ", "vct": "1 1 ", "wsm": "1 1 ", "smr": "1 1 ", "lca": "1 1 ", "stp": "1 1 ", "syc": "1 1 ", "sle": "1 1 ", "sgp": "1 1 ", "svk": "1 1 ", "svn": "1 1 ", "slb": "1 1 ",\
		"cze": "2 2 ","est": "2 2 ","geo": "2 2 ","gtm": "2 2 ","hnd": "2 2 ","guf": "2 2 ","hun": "2 2 ","irl": "2 2 ","jor": "2 2 ","lbr": "2 2 ","ltu": "2 2 ","pan": "1 1 ","sur": "1 1 ","lva": "2 2 ",
				}
	...
	if type=="check":
		...
		if rcp != "baseline":
			for country in countrytilelist[int(n):]:
					...
					for var in monthDic:
						...
						for tile in range(0, int(int(str(countryDic [country[:-5]]).split(" ")[0]) * int(str(countryDic [country[:-5]]).split(" ")[1]) - 1) + 1, 1):
							...
							for month in range(1, int(monthDic [var]) + 1, 1):
								...
								if not arcpy.Exists(tiff) or os.path.getsize(tiff) == 0:
									print country,model,os.path.basename(tiff),"NO"
									outFile = open(dirbase + "\\" + rcp +'_'+resolution+"_check.txt", "a")
									outFile.write(country.split("\n")[0] + "\t" + model + "\t" + resolution + "\t" + var+ "_" + str(month) + "\n")
									outFile.close()
		...
		if not os.path.exists(dirbase + "\\" + rcp +'_'+resolution+"_check_unique.txt"):
			...
			file.writelines(["%s" % item  for item in check])
		l.close()
		lastDate = datetime.datetime.strptime('2014 11 19 11:00', "%Y %m %d %H:%M" )
		
		print '----------- Fix check -----------------------\n'
		# print check
		print '\n-------------------------------------\n'
		
		checkNew = open(dirbase + "\\" + rcp +'_'+resolution+"_check_unique.txt", "r")
		check = [i for i in checkNew.readlines()]
		count=int(start)-1
		for item in  check[int(start):int(end)]:
			...
			print " fixing...", rcp, country+'_adm', model,resolution, var,'count: '+str(count)
			input = base + rcp +"\\"+ country + "_" + str(resolution)
			...
			if os.path.basename(raster).split("_")[0] == "bio" or os.path.basename(raster).split("_")[0] == "prec" or os.path.basename(raster).split("_")[0] == "tmean" or os.path.basename(raster).split("_")[0] == "dtr":
				...
				n= int(str(countryDic [country]).split(" ")[0]) * int(str(countryDic [country]).split(" ")[1])
				for i in range(0,n):
					tileTif= rcp+"_"+period+"_"+model+"_"+var + "_" + str(i)+".tif"
					tile_file = diroutGridsVar + "\\" + tileTif
					print "\tspliting .. ",tileTif
					if arcpy.Exists(tile_file):

						# OBTIENE LA FECHA DE MODICIACION DEL ARCHIVO						
						# date=time.ctime(os.path.getctime(tile_file))
						# dateFile=datetime.datetime.strptime(date, "%a %b %d %H:%M:%S %Y")
						# if dateFile < lastDate:
							# arcpy.Delete_management(diroutGridsVar + "\\" + tileTif)
						os.system("del "+tile_file)
						
				# tile_file=  diroutGridsVar + "\\" +rcp+"_"+period+"_"+model+"_"+var + "_" + str(n-1)+".tif"
					# if arcpy.Exists(tile_file):
						# date=time.ctime(os.path.getctime(tile_file))
						# dateFile=datetime.datetime.strptime(date, "%a %b %d %H:%M:%S %Y")
						# if dateFile < lastDate:
				tile_file=  diroutGridsVar + "\\" +rcp+"_"+period+"_"+model+"_"+var + "_" + str(n-1)+".tif"
				if not arcpy.Exists(tile_file):						
