...
GLAM_optimise_param <- function(opt_data,sect="glam_param.ygp",param="YGP",n.steps=20,iter=1) {
  ...
  #output directories #here i am!!!
  if (opt_data$USE_SCRATCH) {
    cal_dir <- opt_data$SCRATCH #calibration directory
    nfs_dir <- paste(opt_data$CAL_DIR,"/",simset,sep="")
