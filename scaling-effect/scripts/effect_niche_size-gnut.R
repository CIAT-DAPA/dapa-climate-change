...
legend(1.5,20,legend=c("All","Growing area > 5 %"),col=c("blue","red"),pch=c(1,1),bg="white",cex=0.9)
dev.off()
...
legend(-20,20,legend=c("All","Growing area > 5 %"),col=c("blue","red"),pch=c(1,1),bg="white",cex=0.9)
dev.off()
...
box(lwd=1.75)
grid(lwd=0.5)
legend(-0.75,20,legend=c("All","Growing area > 5 %"),col=c("blue","red"),lty=c(1,1),bg="white",cex=0.9)
dev.off()
...
box(lwd=1.75)
grid(lwd=0.5)
legend(7,20,legend=c("All","Growing area > 5 %"),col=c("blue","red"),lty=c(1,1),bg="white",cex=0.9)
dev.off()
