...
pdf(paste(scaleplotDir,"/SI-Fig11d_ecocrop_g2_temperature.pdf",sep=""),width=8,height=5,family="Helvetica")
print(p)
dev.off()
...
pdf(paste(scaleplotDir,"/SI-Fig11c_ecocrop_g2_precipitation.pdf",sep=""),width=8,height=5,pointsize=12,family="Helvetica")
print(p)
dev.off()
