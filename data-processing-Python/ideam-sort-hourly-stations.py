...
if len(sys.argv) < 2:
	os.system('cls')
	print "\n Too few args"
	print "   - ie: python ideam-sort-hourly-stations.py S:\observed\weather_station\ideam-col\organized-daily\automatic"
	sys.exit(1)
...
print "\n"
print "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
print "     Sort by date ideam hourly files		" 
print "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
print "\n"

varlist = "evap", "prec", "rhum", "srad", "sradv", "tmax", "tmean", "tmin", "wsmean"
