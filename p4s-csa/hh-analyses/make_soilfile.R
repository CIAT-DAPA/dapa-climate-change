...
make_soilfile <- function(in_data, out_file, overwrite=F) {
  ...
  #pf <- file(out_file,open="w")
  cat("*P4NE000001  NIGER       SCL     200 GENERIC SOIL PROFILE\n",file=pf)
  ...
  cat(paste(sprintf("%1$6s%2$6.2f%3$6.1f%4$6.2f%5$6.1f%6$6.2f%7$6.2f%8$6s%9$6s%10$6s",
  ...
  for (i in 1:nrow(in_data$profile)) {
    cat(paste(sprintf("%1$6d%2$6s%3$6.3f%4$6.3f%5$6.3f%6$6.2f%7$6.2f%8$6.2f%9$6.2f%10$6.1f%11$6.1f",
              ...
              sprintf("%1$6.1f%2$6.2f%3$6.1f%4$6.1f%5$6.1f%6$6.1f",
