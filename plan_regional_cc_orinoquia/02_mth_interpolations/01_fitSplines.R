...
splineFitting <- function(anuDir="C:/Users/jardila/Desktop/monthly-interpolations/anu/Anuspl43/bin", stDir, rDir, oDir, fold, train.per=0.85, vn="rain", ntiles=1, unix=F, suffix="some") {
    ...
    for (tile in 1:ntiles) {
      ...
      if (!file.exists(paste(vn, "_12.asc", sep=""))) {
