...
# ##load directories (en el futuro cambiare el setwd)
# setwd("D:/CIAT/Projects/col-usaid/02_monthly_interpolation/_scripts")
# anuDir <- "D:/CIAT/Projects/col-usaid/02_monthly_interpolation/anu/Anuspl43/bin"
# stDir <- "D:/CIAT/Projects/col-usaid/02_monthly_interpolation/stations-averages"
# rDir <- "D:/CIAT/Projects/col-usaid/02_monthly_interpolation/region"
# oDir <- "D:/CIAT/Projects/col-usaid/02_monthly_interpolation/outputs_complemented"
...
# ###re direccionando
# stDir <-paste0(stDir,"/",period)
# oDir<-paste0(oDir,"/",period,"/",vn) 
# # source("01_fitSplines.R")

#Cross-validation information and general set up
#Do it by tiles and in thirds

splineFitting <- function(anuDir="/anu/Anuspl43/bin", stDir, rDir, oDir, nfolds=25, train.per=0.85, vn="rain", ntiles=1, unix=F, suffix="some", xt=c(-1,1,-1,1), fold=1, yr="1981_2010") {
