##########################################################################################
## Purpose: Plots for Weather Stations (daily and monthly)
...
map_na <- function(bDir="Z:/DATA/WP2/01_Weather_Stations", dst="GHCN", var="prec", rg=c(-79.5, -72, -11.9, 3), sY=1971, fY=2010, rgname, oDir="Z:/DATA/WP2/04_Evaluations/WTH_ST", mskDir="Z:/GEODATA/AMAZON/SHAPEFILES/Ecoregions", type="nas"){
  ...
  tiff(paste(oDir, "/map_", type, "_monthly_", var, "_", rgname, "_lr.tif", sep=""), width=1600, height = 570, pointsize=8, compression='lzw',res=100)
    print(p)
  dev.off()  
...
clim_plot <- function(bDir="Z:/DATA/WP2/01_Weather_Stations/MERGE", rgname, oDir="Z:/DATA/WP2/04_Evaluations/WTH_ST", rg=c(-79.5, -72, -11.9, 3), mskDir="Z:/GEODATA/AMAZON/SHAPEFILES/Ecoregions"){
  ...
  for (var in varList){
    ...
    tiff(paste(oDir, "/map_cover_climatology_", var, "_", rgname, "_lr.tif", sep=""), width=1600, height = 580, pointsize=8, compression='lzw',res=100)
    print(p)
    dev.off()    
  }
...
sY=1971
fY=2010
oDir="Z:/DATA/WP2/04_Evaluations/01_weather_stations_comparissons/map_coverage"
varList <- c("prec", "tmax", "tmin")
...
rgname <- "amazon"
rg <- c(-80, -66, -16, 5)
oDir = "Z:/DATA/WP2/04_Evaluations/01_weather_stations_comparissons/map_coverage_by_climatology"
mskDir ="Z:/DATA/WP2/00_zones"

clim_plot(bDir, rgname, oDir, rg, mskDir)
