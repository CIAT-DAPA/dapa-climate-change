...
runsDir_p2 <- paste(bDir2,"/adapt/",runs_name,"_v2",sep="")
...
gcmList <- data.frame(GCM=gcmList_p1,RDIR=rep(runsDir_p1,times=length(gcmList_p1)))
...
adap_runs <- read.table(paste(cropDir,"/adapt/data/adapt_v2.tab",sep=""),sep="\t",header=T)
