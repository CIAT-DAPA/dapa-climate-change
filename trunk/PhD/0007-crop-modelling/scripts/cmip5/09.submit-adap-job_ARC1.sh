...
#361 363 364 392 393 394 399 400 401 402 428 429 430 431 432 433 434 435 436 437 535 536 537 538 539 564 565 566 567 568 569 570 571 572 573 574 578 579 600 601 602 603 604 605 606 607 608 609 610 613 
for LOC in 464 465 466 467 468 471 472 499 500 501 502 503 504 505 529 530 531 532 533 534 535 536 537 538 539 564 565 566 567 568 569 570 571 572 573 574 578 579 600 601 602 603 604 605 606 607 608 609 610 613
do
	#process name
	...
	echo ---- ${NPROC} processess queuing currently ---------
	echo ----------------------------------------------------------
	echo ----------------------------------------------------------
	...
	then
  	...
  	#count number of submitted processes
  	NPROC=$(qstat -u eejarv | grep run.sh | wc -l)
  	while [ ${NPROC} -ge 20 ]
  	do
  		echo Idle process.
