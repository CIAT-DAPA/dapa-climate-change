...
if len(sys.argv) < 7:
	os.system('cls')
	print "\n Too few args"
	print "   - ie: python Extract_MaskGCM_v1.py P:\ClimateData\GCM_data\Global_30s A2a G:\Masks\COL_adm\COL_adm0.dbf G:\climate_change\IPCC_CMIP3\COL_Extract csiro_mk2 downscaled"
