...
modellist = sorted(os.listdir(dirbase + "\\" + type + "\\SRES_" + scenario + "\\Global_" + str(resolution)))
	...
	if not os.path.exists(diroutpoints + "\\SRES_" + scenario + "_" + model + "_" + period + "_done.txt"):
		for month in range (1, 12 + 1, 1):
			for variable in variablelist:
				...
				gp.workspace = dirbase + "\\" + type + "\\SRES_" + scenario + "\\Global_" + str(resolution) + "\\" + model + "\\" + period
