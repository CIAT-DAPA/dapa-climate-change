...
# Pourpose: Make a ArcMap file (mxd) from a list of layers
# -----------------------------------------------------------
...
if len(sys.argv) < 6:
	os.system('cls')
	print "\n Too few args"
	print "   - ie: python SaveLaterToMap.py \\172.22.33.33\Geodata\climate_change\IPCC_CMIP3 D:\climate_change\IPCC_CMIP3\_layers A1B 10min downscaled"
	sys.exit(1)
