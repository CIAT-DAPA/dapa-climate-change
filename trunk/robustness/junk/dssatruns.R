...
#arguments
run_data <- list()
run_data$MODEL <- "MZCER045" #MZIXM045
...
run_data$SOILS <- grab_soils(run_data, xy_main)
...
run_data$XFILE <- grab_xfile(run_data)

#at this point modifications can be introduced in the parameters being looked at 
