...
list_gcm_EMN=list.files("D:/Maxent_Nicaragua/mxe_outputs/sp-coffea_arabica_1/projections/averages/extracts/gcm/",full.names=T,pattern="EMN.csv")
...
altitude=read.csv("D:/Maxent_Nicaragua/mxe_outputs/sp-coffea_arabica_1/projections/averages/extracts/alt.csv")
...
list_gcm_ESD=list.files("D:/Maxent_Nicaragua/mxe_outputs/sp-coffea_arabica_1/projections/averages/extracts/gcm/",full.names=T,pattern="ESD.csv")
...
##Area Data##
#############
tiff(paste("D:/Maxent_Nicaragua/mxe_outputs/sp-coffea_arabica_1/projections/averages/extracts/graph.tif", sep=""),width=1024, height=768,pointsize=8,compression='lzw',res=150)
area=read.csv("D:/Maxent_Nicaragua/mxe_outputs/sp-coffea_arabica_1/projections/averages/extracts/altitude_vs_area.csv")
...
par(mar=c(4,4,4,5))
plot(gcm$alt,gcm$bccr_bcm2_0,type="l",xaxt="n", yaxt="n",xlim=c(0,1900),ylim=c(0,1),col="white",xlab="Altitude (m)",ylab="Suitability",main="Suitability Variantions With Altitude")
axis(1, las=1)
axis(2, las=2)
...
legend(80,6200, c("Current","Average 2050","Stdv","21 Models","Area"),
       lty=c(1,1,3,1,1),col=c("red","black","black","gray","green4"),cex=0.6,
