...
pdf(paste(figDir,"/eval_aharv_gnut.pdf",sep=""), height=4,width=5,pointsize=16)
...
pdf(paste(figDir,"/eval_suit_obs_gnut.pdf",sep=""), height=4,width=5,pointsize=16)
...
pdf(paste(figDir,"/eval_suit_12km_exp_gnut.pdf",sep=""), height=4,width=5,pointsize=16)
tplot <- rs_levplot2(gsuit,zn=0,zx=100,nb=20,scale="RdYlGn",ncol=11,rev=T,leg=T)
print(tplot)
dev.off()
