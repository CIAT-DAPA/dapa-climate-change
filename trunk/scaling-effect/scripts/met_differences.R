...
plot(meteffect$suitdiff, meteffect$precdiff, pch=20, ylim=c(-100,20), xlim=c(-60,40),
...
par(las=1, mar=c(4.5,4.5,1,1))
plot(meteffect$suitdiff, meteffect$tmendiff, pch=20, xlim=c(-60,40), ylim=c(-0.5,1.5),
