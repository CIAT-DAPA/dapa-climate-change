...
pdf(paste(figDir,"/SI-Fig06c_ecocrop_all.pdf",sep=""), height=6,width=8,pointsize=12,family="Helvetica")
print(p)
dev.off()
...
pdf(paste(figDir,"/SI-Fig06d_ecocrop_niche.pdf",sep=""), height=6,width=8,pointsize=12,family="Helvetica")
print(p)
dev.off()
