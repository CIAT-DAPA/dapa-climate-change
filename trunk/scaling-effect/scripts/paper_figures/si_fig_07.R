...
###
#heatmaps for 12km all and niche for groundnut
###
...
pdf(paste(figDir,"/SI-Fig07d_ecocrop_12km_all.pdf",sep=""), height=6,width=8,pointsize=12,family="Helvetica")
print(p)
dev.off()
...
pdf(paste(figDir,"/SI-Fig07e_ecocrop_12km_niche.pdf",sep=""), height=6,width=8,pointsize=12,family="Helvetica")
print(p)
dev.off()
...
#heatmap of sensitivity of 3deg runs
hplot_df <- outsens[,c("prec","temp","reldiff_all")]
hplot_df$prec <- as.factor(hplot_df$prec*100)
hplot_df$temp <- as.factor(hplot_df$temp)
...
pdf(paste(figDir,"/SI-Fig07f_ecocrop_3deg_all.pdf",sep=""), height=6,width=8,pointsize=12,family="Helvetica")
print(p)
dev.off()
