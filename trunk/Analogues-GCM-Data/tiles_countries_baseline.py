...
if len(sys.argv) < 6:
	os.system('cls')
	print "\n Too few args"
	print "   - ie: python tiles_countries_baseline.py S:\data\portals\analogues-gcm-data\ExtractByCountry baseline S:\data\portals\analogues-gcm-data\TilesByCountry 30s 1960_1990"
	sys.exit(1)
...
countrytilelist = "chn", "dnk", "grl", "idn", "ind", "irn", "ita", "jpn", "kaz", "kgz", "lao", "lby", "mar", "mdg", "nic", "pol", "prt", "pry", "sjm", "slb", "som", "tha", "tkm", "tur", "ukr"
...
for country in countrytilelist:
	...
	arcpy.env.workspace = dirbase + "\\" + sres + "\\" + country + "_" + str(resolution) + "\\" + model
	...
	# os.system("7za a " + dirbase + "\\SRES_" + sres + "\\downscaled\\" + country + "_" + str(resolution) + ".zip " + dirbase + "\\SRES_" + sres + "\\downscaled\\" + country + "_" + str(resolution))
	os.system("rmdir /s /q " + dirbase + "\\" + sres + "\\" + country + "_" + str(resolution))
