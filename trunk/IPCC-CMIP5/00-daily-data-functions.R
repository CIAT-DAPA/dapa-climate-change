...
GCM_Cut_Daily <- function(baseDir="T:/gcm/cmip5/raw/daily", ens="r1i1p1", rcp="historical", xmin=-18, xmax=-11, ymin=12, ymax=17, staYr=1850, endYr=2100, outDir="D:/CIAT/Workspace/cmip5_daily_test", shift="yes") {
  ...
  for (gcm in gcmList) {
    ...
    if (!file.exists(verFile)){
      ...
      cat(paste("Cut CMIP5 daily ", ens, " ", rcp, " for extent ", xmin, ",", xmax, ",", ymin, ",", ymax, " was processed on ", date(), sep=""), file=opnFile)
