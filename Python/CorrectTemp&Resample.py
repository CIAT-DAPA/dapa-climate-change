...
if len(sys.argv) < 5:
	...
	print "    - ie: python CorrectTemp&Resample.py D:\climate_change\IPCC_CMIP3\Nepal_Extract A1B D:\climate_change\IPCC_CMIP3\NepalCorrected_Extract D:\climate_change\IPCC_CMIP3\tmp"
	sys.exit(1)
