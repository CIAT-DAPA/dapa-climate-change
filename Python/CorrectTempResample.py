...
if len(sys.argv) < 5:
	...
	print "    - ie: python CorrectTempResample.py D:\climate_change\IPCC_CMIP3\Nepal_Extract A1B D:\climate_change\IPCC_CMIP3\NepalResample_Extract D:\climate_change\IPCC_CMIP3\tmp"
	sys.exit(1)
...
for model in modellist:
	...
	# Create Dir Resample folders
	gp.workspace = dirout + "\\" + model + "\\" + period
	diroutAscii = "D:\climate_change\IPCC_CMIP3\SRES_A1B_Nepal_2_5km"
