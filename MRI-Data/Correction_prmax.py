...
if len(sys.argv) < 6:
	...
	print "   - ie: python Correction_MRI.py W:\MRIData\MRIAAIGrid\SP0A 1979 2003 prmax D:\MRI_grids\temp"
	sys.exit(1)
...
for yr in yrList:
	...
	foldersout = dirout + "\\OUT_" + str(yr) + "010000"
	...
	for rs in rsList:
		...
		print os.path.basename(rs),dirtemp,"GRID"
