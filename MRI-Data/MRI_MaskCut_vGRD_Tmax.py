...
GRD_dir = 'E:\\MRI_grids\\tmax\\' + FolderName + '\\'
...
##			print '    . OUT_' + YearD + MonthD + '010000\\' + VarCli + '_' + MonthD + '_' + DayD
		...
		if gp.exists(GRD_dir + 'OUT_' + YearD + MonthD + '010000\\' + VarCli + '_' + DayD):
			print '  ... procesando ' + VarCli + '_' + YearD + MonthD + DayD
			InRaster = GRD_dir + 'OUT_' + YearD + MonthD + '010000\\' + VarCli + '_' + DayD
			OutPointFeatures = OUT_dir + VarCli + '_' + DayD + '.shp'
			tmpRaster = OUT_dir + YearD + '\\t_day_' + YearD[2:] + '' + MonthD + '' + DayD
			OutRaster = OUT_dir + YearD + '\\' + VarCli + '_' + YearD + MonthD + DayD
			...
			if not gp.exists(OutRaster):
				...
				# Process: Spline
				gp.Spline_sa(OutPointFeatures, "GRID_CODE", OutRaster, "0.0416666666667", "REGULARIZED", "0", "4")
...
##				gp.delete_management(tmpRaster)
			...
			print "NO EXISTE " + GRD_dir + 'OUT_' + YearD + MonthD + '010000\\' + VarCli + '_' + DayD
