# python ZipGrids_process_disaggregation.py S:\data\gcm\cmip3 disaggregated a1b ALL ALL ALL
...
for model in modellist:
	for period in periodlist:
		...
		for variable in variablelist:
			if not os.path.exists(gp.workspace + "\\" + variable.split("_")[0] + "_grd.zip"):
		...
		for var in list:
			if not os.path.exists(gp.workspace + "\\" + var + "_grd.zip"):
				print "\ncompressing...",var
