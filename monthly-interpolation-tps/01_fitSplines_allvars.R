...
# 
# setwd("D:/cenavarro/col-cormacarena/monthly-interpolations-llanos/_scripts")
# anuDir <- "D:/cenavarro/col-cormacarena/monthly-interpolations-llanos/anu/Anuspl43/bin"
# stDir <- "D:/cenavarro/col-cormacarena/monthly-interpolations-llanos/stations-averages"
# rDir <- "D:/cenavarro/col-cormacarena/monthly-interpolations-llanos/_region"
# outDir <- "D:/cenavarro/col-cormacarena/monthly-interpolations-llanos/outputs"
# train.per <- 0.85
# vnList <- c("rain", "tmax", "tmin")
# tile <- 1
# ntiles <- 1
# suffix <-"l98"
# nfolds=25
# rg <- "lla"
# source("01_fitSplines_allvars.R")
...
splineFitting <- function(anuDir="C:/Users/jardila/Desktop/monthly-interpolations/anu/Anuspl43/bin", stDir, rDir, outDir, nfolds=25, train.per=0.85, vnList=c("rain", "tmax", "tmin"), ntiles=1, unix=F, suffix="some", rg="lla") {
  ...
  for (vn in vnList){
    ...
    oDir <- paste0(outDir, "_", suffix, "/", vn)
    ...
    msk <- raster(paste(rDir, "/alt-prj-",rg, ".asc", sep=""))
    xt <- extent(msk)
    xt@xmin <- xt@xmin #- 75
    xt@xmax <- xt@xmax #- 71
    xt@ymin <- xt@ymin #+ 1
...
otp <- splineFitting(anuDir, stDir, rDir, outDir, nfolds, train.per, vnList, ntiles, unix=F, suffix, rg)
