...
if len(sys.argv) < 5:
	os.system('cls')
	print "\n Too few args"
	print "   - ie: python 00_LatLonRaster_v2.py D:\CIAT\Projects\col-usaid\02_monthly_interpolation\region\250m\alt-prj-ris.asc D:\CIAT\Projects\col-usaid\02_monthly_interpolation\region\500m_v2 ris 1"
	sys.exit(1)
...
if not arcpy.Exists(OutAlt):
	arcpy.Clip_management(dem, "-76.6 4.5 -75.2 5.6", OutAlt)
