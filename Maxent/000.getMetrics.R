...
# crossValDir <- "D:/Maxent_Nicaragua/mxe_outputs/sp-coffea_arabica/crossval"
# foldSuffix <- "coffea_arabica"
# nFolds <- 25
# outMetDir <- "D:/Maxent_Nicaragua/mxe_outputs/sp-coffea_arabica/metrics"
# out <- getMetrics(crossValDir, foldSuffix, nFolds, outMetDir)
