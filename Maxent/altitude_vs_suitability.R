...
list_gcm_EMN=list.files("C:/Users/David Arango/Desktop/extracts/gcm/",full.names=T,pattern="EMN.csv")
...
altitude=read.csv("C:/Users/David Arango/Desktop/extracts/alt.csv")
...
list_gcm_ESD=list.files("C:/Users/David Arango/Desktop/extracts/gcm/",full.names=T,pattern="ESD.csv")
...
area=read.csv("C:/Users/David Arango/Desktop/extracts/altitude_vs_area.csv")
...
par(mar=c(4,4,4,5))
plot(gcm$alt,gcm$bccr_bcm2_0,type="l",xaxt="n", yaxt="n",xlim=c(0,1900),ylim=c(0,0.8),col="white",xlab="Altitude (m)",ylab="Suitability",main="Suitability Variantions With Altitude")
axis(1, las=1)
axis(2, las=2)
...
legend(100,6200, c("Current","Average 2050","Stdv","21 Models","Area"),
