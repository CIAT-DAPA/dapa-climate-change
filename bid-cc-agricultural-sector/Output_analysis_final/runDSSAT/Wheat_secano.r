 ...
 # cultivar = c('IB0024','ChinaBBA')  #fijar cultivar aqui
  #cultivar = c('IB0029','KauzBA')
  cultivar = c('IB0034','AVALON')
  ...
  day30 <- rep(0, length(crop_secano$N.app.30))
  day_aplication30 <- rep(2, length(day30))
