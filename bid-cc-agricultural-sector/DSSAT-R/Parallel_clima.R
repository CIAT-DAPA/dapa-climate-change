################################################# WFD  (WATCH Forcing Data (WFD) #########################################################
## Extract Climatic values WFD in parallel
#
library(snowfall)
...
Coordenadas[,1]<-Coordenadas[,1]+360  ## Change Rotation

## Load Values in each of the Processors
sfExportAll()

## Stack Climatic Values
