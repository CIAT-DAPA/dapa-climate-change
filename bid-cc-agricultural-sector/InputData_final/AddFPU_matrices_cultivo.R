...
path <- "/mnt/workspace_cluster_3/bid-cc-agricultural-sector/08-Cells_toRun/matrices_cultivo/"

# Load FPU shape file
worldFPU <- readShapePoly(fn="/mnt/workspace_cluster_3/bid-cc-agricultural-sector/15_FPUs/fpu_shp/fpu.shp",proj4string=CRS("+proj=longlat +datum=WGS84 +ellps=WGS84 +towgs84=0,0,0"))
